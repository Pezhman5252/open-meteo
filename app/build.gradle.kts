...
tasks.register("downloadVazirmatnFont") {
    ...
    doLast {
        ...
        if (!regularFile.exists()) {
            ...
            ant.invokeMethod("get", mapOf("src" to "https://github.com/rastikerdar/vazirmatn/raw/master/fonts/ttf/Vazirmatn-Regular.ttf", "dest" to regularFile))
        }
        if (!boldFile.exists()) {
            println("Downloading Vazirmatn-Bold Font...")
            ant.invokeMethod("get", mapOf("src" to "https://github.com/rastikerdar/vazirmatn/raw/master/fonts/ttf/Vazirmatn-Bold.ttf", "dest" to boldFile))
        }
        if (!mediumFile.exists()) {
            println("Downloading Vazirmatn-Medium Font...")
            ant.invokeMethod("get", mapOf("src" to "https://github.com/rastikerdar/vazirmatn/raw/master/fonts/ttf/Vazirmatn-Medium.ttf", "dest" to mediumFile))
        }
    }
}
